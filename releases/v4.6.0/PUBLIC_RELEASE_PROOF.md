...
- 项目：Visual
- 版本 Tag：`v4.6.0`
- 提交 SHA：`d34a04031c49123b3cfea79760280d901947be96`
- 提交作者：`JiangnanZhang-2006 <zjn.2006@foxmail.com>`
- 提交时间：`2026-03-28T00:39:38+08:00`
- 生成时间（UTC）：`2026-03-27T16:40:38Z`
...
2. 验证 Tag 签名：
   ```bash
   git verify-tag v4.6.0
   git show v4.6.0 --show-signature
   ```
3. 核对签名身份与指纹是否一致：
