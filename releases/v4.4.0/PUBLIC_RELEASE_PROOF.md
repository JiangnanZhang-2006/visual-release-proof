...
- 项目：Visual
- 版本 Tag：`v4.4.0`
- 提交 SHA：`0fb27650a87039a6f6b7f85e1108e3131d5b6d38`
- 提交作者：`JiangnanZhang-2006 <zjn.2006@foxmail.com>`
- 提交时间：`2026-03-27T22:56:59+08:00`
- 生成时间（UTC）：`2026-03-27T14:58:11Z`
...
2. 验证 Tag 签名：
   ```bash
   git verify-tag v4.4.0
   git show v4.4.0 --show-signature
   ```
3. 核对签名身份与指纹是否一致：
